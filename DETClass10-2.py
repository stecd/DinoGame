...
credential_path = "/home/pi/DET2019viz.json" #replace with your file name!
...
def LED_Action(numbers):
    ...
    LED_1 = crickit.SIGNAL1    # LED #1 connected to signal port 1 & ground YELLOW
    LED_2 = crickit.SIGNAL2    # LED #2 connected to signal port 2 & ground RED
    LED_3 = crickit.SIGNAL3    # LED #3 connected to signal port 3 & ground GREEN
